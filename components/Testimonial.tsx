        ...
        <div class="grid md:grid-cols-2 gap-6 max-w-7xl mx-auto">
            ...
            <div>
              ...
              <blockquote class="mt-2">
                <p class="text-base text-slate-400 font-normal leading-relaxed">
                  ...
                  emails. My clients love how easy it is to book a meeting with
                  me.
                </p>
              </blockquote>
            </div>
          ...
          <figure class="flex min-[1200px]:items-center max-[1200px]:flex-col gap-6 rounded-xl p-4 border border-neutral-700 md:p-6">
            ...
            <div>
              ...
              <blockquote class="mt-2">
                <p class="text-base text-slate-400 font-normal leading-relaxed">
                  Since implementing this service, my booking rate has increased
                  by 35%. The time zone feature is a game-changer for my
          ...
          <figure class="flex min-[1200px]:items-center max-[1200px]:flex-col gap-6 rounded-xl p-4 border border-neutral-700 md:p-6">
            ...
            <div>
              ...
              <blockquote class="mt-2">
                <p class="text-base text-slate-400 font-normal leading-relaxed">
                  Our team manages over 200 client meetings per month, and this
                  service has streamlined our entire process. The group
            ...
            <div>
              ...
              <blockquote class="mt-2">
                <p class="text-base text-slate-400 font-normal leading-relaxed">
                  ...
                  back-to-back meetings. I've reclaimed at least 5 hours weekly
                  that I used to spend on scheduling.
                </p>
              </blockquote>
            </div>
          </figure>
            ...
            <div>
              ...
              <blockquote class="mt-2">
                <p class="text-base text-slate-400 font-normal leading-relaxed">
                  ...
                  privacy features and seamless HIPAA compliance make it perfect
                  for my practice.
                </p>
              </blockquote>
            </div>
